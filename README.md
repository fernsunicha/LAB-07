...
_value	| ได้ |	เป็นคำไม่สงวน
First-name | ใช่ไม่ได้| มีเครื่องหมายทางคณิตศาสตร์อยู่ในชื่อ			
Hello!	| ใช้ได้| เป็นคำไม่สงวน	
w*h 	|ใช้ได้ |เป็นคำไม่สงวน			
time	|ใช้ไม่ได้ |เป็นคำสงวนในภาษา C#		
do	| ใช้ไม่ได้| เป็นคำสงวนในภาษา C#		
Do	| ใช้ได้|เป็นคำไม่สงวน		
21November	| ใช้ได้|เป็นคำไม่สงวน		
ladkrabang	| ใช้ได้|เป็นคำไม่สงวน		
Student ID	| ใช้ได้|เป็นคำไม่สงวน			
